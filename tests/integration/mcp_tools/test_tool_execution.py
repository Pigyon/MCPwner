...
@pytest.mark.asyncio
async def test_health_check_tool(docker_compose_up, mcp_session):
    session = mcp_session
    client = mcp_session
...
@pytest.mark.asyncio
async def test_list_tools_tool(docker_compose_up, mcp_session):
    session = mcp_session
    client = mcp_session
...
@pytest.mark.asyncio
async def test_workspace_list_workspaces_tool(docker_compose_up, mcp_session):
    session = mcp_session
    client = mcp_session
...
@pytest.mark.asyncio
async def test_codeql_list_databases_tool(docker_compose_up, mcp_session):
    session = mcp_session
    client = mcp_session
...
@pytest.mark.asyncio
async def test_codeql_list_query_packs_tool(docker_compose_up, mcp_session):
    session = mcp_session
    client = mcp_session
...
@pytest.mark.asyncio
async def test_sast_list_tools_tool(docker_compose_up, mcp_session):
    session = mcp_session
    client = mcp_session
...
@pytest.mark.asyncio
async def test_workspace_create_workspace_tool(docker_compose_up, mcp_session):
    session = mcp_session
    client = mcp_session
...
@pytest.mark.asyncio
async def test_workspace_cleanup_workspace_tool(docker_compose_up, mcp_session):
    session = mcp_session
    client = mcp_session
...
async def test_list_tools(docker_compose_up, mcp_session, tool_name):
    session = mcp_session
    client = mcp_session
