...
def list_functions(database_id: str, language: Optional[str] = None, limit: int = 100) -> dict:
    """
    ...
    return list_func(database_id=database_id, language=language, limit=limit)
